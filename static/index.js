...
// function createSortingControls(data) {
//   // Get column names from the first row of data
//   const columns = Object.keys(data[0] || {});
  
//   // Remove any existing sorting controls
//   d3.select('.control-panel').selectAll('.sorting-container .sorting-controls').remove();
...
//   const containers = d3.selectAll('.visualization-container');
...
//     // Reset to original order if you have stored it, or maintain current order
//     updateVisualization(container, data);
//   });
// }

// // Initialize sorting controls when data is loaded
// function initializeSortingControls(data) {
//   createSortingControls(data);
// }
